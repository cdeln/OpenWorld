...
void init(void)
{
    ...
    terrain_shader = loadShaders(
            "shaders/terrain_weather.vert",
            "shaders/terrain_weather.frag");
    ...
    // Load terrain data
    map_size = 1024;
    map_height = 200; //static_cast<GLfloat>(map_size)/8;
    ...
    //terrain_tex_objID[4] = cd::loadTexture2D("data/textures/TexturesCom_Cliffs0265_1_seamless_S.jpg");
